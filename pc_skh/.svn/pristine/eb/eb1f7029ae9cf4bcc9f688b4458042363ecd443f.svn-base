	...
	t.prototype = {
		...
		slide: function(t, n) {
			var r = this.$element.find(".item.active"),
			    ...
			    //$('.huizhenBannerBg').css('background-color') =  i.css('background-color') ;
				 
				//var mycolor =  i.css('background-color');
				 
				//$('.huizhenBannerBg').css('background-color','mycolor');
			...
			this.$indicators.length && (this.$indicators.find(".active").removeClass("active"), this.$element.one("slid", function() {
				...
				//$(".mainbg").css({'background-color':$("#carousel-547274 .item:visible").css("background-color")});
