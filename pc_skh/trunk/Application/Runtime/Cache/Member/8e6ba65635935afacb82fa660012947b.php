...
<head>
  ...
  <!-- 当前样式 -->
  <link rel="stylesheet" href="/Public/css/focus/serviceArticle.css">
</head>
<body>
  <!-- 头部start -->
  ...
  <div class="banner con">
    <div class="w1200">
      <p class="title">就诊服务</p>
      <p class="desc">CONSULTATION SERVICE</p>
    </div>
  </div>
  <div class="nav con">
    <div class="w1080">
      <a href="/">首页</a><span>&gt;</span><a href="">就诊服务</a><span>&gt;</span><a href=""><?php echo ($arcinfo['ACT_TITLE']); ?></a>
    </div>
  </div>
  <div class="con1 con">
      ...
      <div class="text">
        ...
        <p class="bottom">
          ...
          <?php else: ?>
            <a href="/Focus/<?php echo ($arcnl['DT_LAST'][0]['RECORD_ID']); ?>/2"><span>上一篇：</span><?php echo ($arcnl['DT_LAST'][0]['ACT_TITLE']); ?></a><?php endif; ?>
          <?php if(!$arcnl['DT_NEXT']): ?><a href="javascript:;"><span>下一篇：</span>没有了</a>
          <?php else: ?>
            <a href="/Focus/<?php echo ($arcnl['DT_NEXT'][0]['RECORD_ID']); ?>/2"><span>下一篇：</span><?php echo ($arcnl['DT_NEXT'][0]['ACT_TITLE']); ?></a><?php endif; ?>
        </p>
      </div>
  </div>
  <!-- 底部start -->
