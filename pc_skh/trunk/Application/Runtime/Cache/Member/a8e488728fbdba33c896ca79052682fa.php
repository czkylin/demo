  ...
  <div class="con1 con">
      ...
      <div class="text">
        ...
        <p class="bottom">
          ...
          <?php else: ?>
            <a href="/Doc/<?php echo ($arcnl['DT_LAST'][0]['RECORD_ID']); ?>"><span>上一篇：</span><?php echo ($arcnl['DT_LAST'][0]['ACT_LECTOR']); ?></a><?php endif; ?>
          <?php if(!$arcnl['DT_NEXT']): ?><a href="javascript:;"><span>下一篇：</span>没有了</a>
          <?php else: ?>
            <a href="/Doc/<?php echo ($arcnl['DT_NEXT'][0]['RECORD_ID']); ?>"><span>下一篇：</span><?php echo ($arcnl['DT_NEXT'][0]['ACT_LECTOR']); ?></a><?php endif; ?>
        </p>
      </div>
  </div>
  <!-- 底部start -->
