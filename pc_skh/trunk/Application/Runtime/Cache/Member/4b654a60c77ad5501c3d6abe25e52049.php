...
<head>
  ...
  <meta content="<?php echo ($seoarr['69942766']['KEYWORDS']); ?>" name="keywords">
  <meta content="<?php echo ($seoarr['69942766']['DESCRIPTION']); ?>" name="description">
  <title><?php echo ($seoarr['69942766']['TITLE']); ?></title>
  <!-- 公共样式 -->
...
<body>
  ...
  <div class="banner con">
    <div class="w1200">
      ...
      <p class="desc">Company News</p>
    </div>
  </div>
  <div class="nav con">
    <div class="w1200">
      <a href="">首页</a><span>></span><a href="">新闻动态</a>
    </div>
  </div>
  <div class="con1 con">
    <div class="w1200">
      <div class="conLeft fl">
        <ul>
          <?php if(is_array($newsList)): $i = 0; $__LIST__ = $newsList;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$news): $mod = ($i % 2 );++$i;?><a href="/Focus/<?php echo ($news['RECORD_ID']); ?>/1"><li><i></i><?php echo ($news['ACT_TITLE']); ?><span class="fr"><?php echo (Dtodiy("Y-m-d",$news['CREATE_DATE'])); ?></span></li></a><?php endforeach; endif; else: echo "$empty" ;endif; ?>
        </ul>
        <ol>
          ...
          <?php echo ($page); ?>
          <!-- <li class="last"><form action="<?php echo U('Focus/news');?>" method="GET"><input type="text" name="p" value="" class="ent"></form></li> -->
        </ol>
