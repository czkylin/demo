...
<head>
  ...
  <!-- 当前样式 -->
  <link rel="stylesheet" href="/Public/css/focus/docDetail.css">
</head>
<body>
  <!-- 头部start -->
  ...
  <div class="nav con">
    <div class="w1080">
      <a href="">首页</a><span>></span><a href="">知名专家</a><span>></span><a href=""><?php echo ($arcinfo['ACT_LECTOR']); ?></a>
    </div>
  </div>
  <div class="con1 con">
      <h2><?php echo ($arcinfo['ACT_LECTOR']); ?></h2>
      <div class="title">
      ...
      <div class="text">
        ...
        <p class="bottom">
          ...
          <?php else: ?>
            <a href="<?php echo U('Focus/docDetail',array('artid'=>$arcnl['DT_LAST'][0]['RECORD_ID']));?>"><span>上一篇：</span><?php echo ($arcnl['DT_LAST'][0]['ACT_LECTOR']); ?></a><?php endif; ?>
          <?php if(!$arcnl['DT_NEXT']): ?><a href="javascript:;"><span>下一篇：</span>没有了</a>
          <?php else: ?>
            <a href="<?php echo U('Focus/docDetail',array('artid'=>$arcnl['DT_NEXT'][0]['RECORD_ID']));?>"><span>下一篇：</span><?php echo ($arcnl['DT_NEXT'][0]['ACT_LECTOR']); ?></a><?php endif; ?>
        </p>
      </div>
  </div>
  <!-- 底部start -->
