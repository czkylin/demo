...
(function (factory) {
    ...
    var cropbox = function(options, el){
        var el = el || $(options.imageBox),
            ...
            imgMouseMove = function(e)
            {
                ...
                if (obj.state.dragable)
                {
                  ...
                  var x = touch.clientX - obj.state.mouseX;
                  var y = touch.clientY - obj.state.mouseY;
        ...
        el.on('remove', function(){$(window).unbind('touchend', imgMouseUp)});
