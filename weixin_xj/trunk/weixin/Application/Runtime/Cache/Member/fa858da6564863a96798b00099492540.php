...
<head>
    ...
    <script type="text/javascript">
        ...
        var wx_share_title = '<?php echo ($user_info["real_name"]); ?>告诉您，百元送父母10万健康保障';
        ...
        wx.ready(function () {
            wx.onMenuShareTimeline({
                ...
                desc: wx_share_desc, 
                link: "http://wx-heartorg.yk2020.com//weixin/index.php?m=Member&c=Huzhu&a=share_parent&user_id=<?php echo ($user_info["user_id"]); ?>&link_mobile=<?php echo ($user_info["link_mobile"]); ?>&user_name=<?php echo ($user_info["user_name"]); ?>", 
            ...
            <div class="swiper-slide">
                ...
                <div class="one_top clear">
                    <div class="ani" swiper-animate-effect="bounceInLeft" swiper-animate-duration="1.5s" swiper-animate-delay="0.3s">
                        <a href="<?php echo U('Member/User/expand_result');?>"> <img src="/weixin/Public/Member/images/zhengcejiedu/img11.jpg" class="f_l"> </a>
                    </div>
                ...
                <div class="one_center">
                    ...
                    <div class="ani" swiper-animate-effect="fadeInDown" swiper-animate-duration="3.9s" swiper-animate-delay="0.9s"><img src="/weixin/Public/Member/images/zhengcejiedu/bot2.png" class="jifen"></div>
                     <div class="ani" swiper-animate-effect="bounceInLeft" swiper-animate-duration="1.5s" swiper-animate-delay="0.9s">
                        <a href="<?php echo U('Member/Huzhu/daiyan_list');?>"> <img src="/weixin/Public/Member/images/zhengcejiedu/img4.jpg" class="f_l img_cg"> </a>
                    </div>
                    <div class="ani" swiper-animate-effect="bounceInRight" swiper-animate-duration="1.5s" swiper-animate-delay="0.9s">
                        <a href="<?php echo U('Member/Huzhu/fx');?>"> <img src="/weixin/Public/Member/images/zhengcejiedu/img5.jpg" class="f_l img_jg"> </a>
                    </div>
                </div>
                <div class="ani tuijian_con" ><a href="<?php echo U('Member/User/expand_list',array('path'=>$path));?>" class="tuijian">我要代言</a></div> <!-- <img src="/weixin/Public/Expert/images/expand/down.png" class="down"> -->
                <div class="hui">
                    <div class="xiangqing">
...
<!--            <div class="swiper-slide">-->
            ...
            <!--<div class="swiper-slide">
                ...
                <div class="ani tuijian_con_last" swiper-animate-effect="fadeInUpBig" swiper-animate-duration="1.1s" swiper-animate-delay="0.9s"><a href="<?php echo U('Member/User/expand_list');?>" class="tuijian_last">我要分享</a></div>
    ...
    <script type="text/javascript">
        ...
        $('.erweima').click(function () {
            ...
            var code = "http://weixin.yk2020.com/include/get_share_code.aspx?a=wxlogin&user_id=<?php echo ($user_info["user_id"]); ?>&link_mobile=<?php echo ($user_info["link_mobile"]); ?>&attach=<?php echo urlencode(base64_encode('m=Member&c=User&a=expand'));?>&user_name=" + username;
            console.log(code);
            $('#pop').show();
