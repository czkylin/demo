...
<body>
    ...
    <!-- 单独代码 -->
    <div style="height:0px;overflow:hidden;"><script src="https://s13.cnzz.com/z_stat.php?id=1263621011&web_id=1263621011" language="JavaScript"></script></div>
</body>
...
<script>
    ...
    wx.ready(function() {
        wx.onMenuShareTimeline({
            ...
            desc: wx_share_desc,
            link: 'http://wx-heartorg.yk2020.com/weixin/index.php?m=Member&c=Huzhu&a=art&user_id=<?php echo I("get.user_id","0");?>&link_mobile=<?php echo I("get.link_mobile","0");?>&user_name='+encodeURIComponent("<?php echo I('get.user_name','');?>"),
