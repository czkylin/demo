		...
		<ul class="list">
			...
			<li class="clear">
	            <div class="selector clear">
	                ...
	                <p><a href="<?php echo U('Member/Huzhu/jiankangguanli',array('user_id'=>$user_info['user_id'],'link_mobile'=>$user_info['link_mobile'],'user_name'=>$user_info['user_name'],'path'=>$path));?>">“1+3”百倍爱心卡健康管理您的身体</a></p>
	            </div>
	            <div class="code" data-code="jiankangguanli">
	                <img src="/weixin/Public/Member/images/huzhu/code.png" alt="“1+3”百倍爱心卡健康管理您的身体">
	            </div>
	        </li>
