...
<body>
	...
	<article style="margin-bottom: 3rem;">
		...
		<?php if(is_array($bx_list1)): $i = 0; $__LIST__ = $bx_list1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$bx): $mod = ($i % 2 );++$i;?><!-- <li class="clear">
			...
			<!-- <li class="clear">
				<div class="selector clear">
					...
					<p><a href="<?php echo U('Member/Huzhu/yilianti',array('user_id'=>$user_info['user_id'],'link_mobile'=>$user_info['link_mobile'],'user_name'=>$user_info['user_name'],'person_id'=>$bx['RECORD_ID'],'path'=>$path));?>">远程视界科技集团小远带您乘坐医联体特快专列</a></p>
				</div>
        ...
        <li class="clear">
				<div class="selector clear">
						<span></span>
						<img src="/weixin/Public/Member/images/huzhu/heart_health/icon.png" alt="">
						<p><a href="<?php echo U('Member/Huzhu/heart_health',array('user_id'=>$user_info['user_id'],'link_mobile'=>$user_info['link_mobile'],'user_name'=>$user_info['user_name'],'path'=>$path));?>">预防>治疗，让“心”更健康</a></p>
				</div>
				<div class="code" data-code="heart_health">
						<img src="/weixin/Public/Member/images/huzhu/code.png" alt="高血压套装">
				</div>
		 </li>
        <li class="clear">
				<div class="selector clear">
						<span></span>
						<img src="/weixin/Public/Member/images/yilianti/icon.jpg" alt="">
						<p><a href="<?php echo U('Member/Huzhu/yilianti',array('user_id'=>$user_info['user_id'],'link_mobile'=>$user_info['link_mobile'],'user_name'=>$user_info['user_name'],'path'=>$path));?>">远程视界科技集团小远带您乘坐医联体特快专列</a></p>
				</div>
				<div class="code" data-code="yilianti">
						<img src="/weixin/Public/Member/images/huzhu/code.png" alt="百倍爱心卡 火热传递中">
				</div>
        ...
        <li class="clear">
            <div class="selector clear">
                ...
                <p><a href="<?php echo U('Member/Huzhu/blood',array('user_id'=>$user_info['user_id'],'link_mobile'=>$user_info['link_mobile'],'user_name'=>$user_info['user_name'],'path'=>$path));?>">百倍爱心高血压健康管理套装带给你健康舒心的呵护!</a></p>
            </div>
      ...
      <li class="clear">
			...
			<!-- <li class="clear">
				<div class="selector clear">
					...
					<p><a href="<?php echo U('Member/Huzhu/share_zntz',array('user_id'=>$user_info['user_id'],'link_mobile'=>$user_info['link_mobile'],'user_name'=>$user_info['user_name'],'path'=>$path));?>">百倍爱心-智能手机健康管理套装</a></p>
				</div>
        	...
        	<li class="clear">
				<div class="selector clear">
					...
					<p><a href="<?php echo U('Member/Huzhu/share_jqr_1',array('user_id'=>$user_info['user_id'],'link_mobile'=>$user_info['link_mobile'],'user_name'=>$user_info['user_name'],'path'=>$path));?>">地球人你好，我是机器人萌萌，有我你家会去大专家,傲娇脸</a></p>
				</div>
        	...
        	<li class="clear">
				<div class="selector clear">
					...
					<p><a href="<?php echo U('Member/Huzhu/share_9900_1',array('user_id'=>$user_info['user_id'],'link_mobile'=>$user_info['link_mobile'],'user_name'=>$user_info['user_name'],'path'=>$path));?>">管理 “心脑血管”疾病 家庭医生为你护航</a></p>
				</div>
			...
			<li class="clear">
	            <div class="selector clear">
	                ...
	                <p><a href="<?php echo U('Member/Huzhu/share_1280_new',array('user_id'=>$user_info['user_id'],'link_mobile'=>$user_info['link_mobile'],'user_name'=>$user_info['user_name'],'path'=>$path));?>">2017，<?php echo base64_decode($user_info['user_name']);?>邀您一起开启慢性病管理！</a></p>
	            </div>
			...
			<!-- <li class="clear">
	            <div class="selector clear">
	                ...
	                <p><a href="<?php echo U('Member/Huzhu/long_9900',array('user_id'=>$user_info['user_id'],'link_mobile'=>$user_info['link_mobile'],'user_name'=>$user_info['user_name'],'path'=>$path));?>">三生三世，十里桃花，夜华君与你相约，还在等什么？走，赴约去...</a></p>
	            </div>
			...
			<li class="clear">
	            <div class="selector clear">
	                ...
	                <p><a href="<?php echo U('Member/Huzhu/jiankangguanli',array('user_id'=>$user_info['user_id'],'link_mobile'=>$user_info['link_mobile'],'user_name'=>$user_info['user_name'],'path'=>$path));?>">“1+3”百倍爱心卡健康管理您的身体，帮助您为最亲的人健康管理</a></p>
	            </div>
	            <div class="code" data-code="jiankangguanli">
	                <img src="/weixin/Public/Member/images/huzhu/code.png" alt="百倍爱心卡 火热传递中">
	            </div>
	        </li>
			...
			<!-- <li class="clear">
	            <div class="selector clear">
	                ...
	                <p><a href="<?php echo U('Member/Huzhu/share_1280_chunjie',array('user_id'=>$user_info['user_id'],'link_mobile'=>$user_info['link_mobile'],'user_name'=>$user_info['user_name'],'path'=>$path));?>">新年礼物已送达，各位快来看看这是啥！</a></p>
	            </div>
			...
			<li class="clear">
	            <div class="selector clear">
	                ...
	                <p><a href="<?php echo U('Member/Huzhu/share_1280_1',array('user_id'=>$user_info['user_id'],'link_mobile'=>$user_info['link_mobile'],'user_name'=>$user_info['user_name'],'path'=>$path));?>">礼物都给你备好了！全在这了！把“我”收了吧！</a></p>
	            </div>
	        ...
	        <!-- <li class="clear">
	            <div class="selector clear">
	                ...
	                <p><a href="<?php echo U('Member/Huzhu/share_498_1',array('user_id'=>$user_info['user_id'],'link_mobile'=>$user_info['link_mobile'],'user_name'=>$user_info['user_name'],'path'=>$path));?>">血管轻松，健康保障！套装更优惠哦!</a></p>
	            </div>
            ...
            <!-- <li class="clear">
				<div class="selector clear">
					...
					<p><a href="<?php echo U('Member/Huzhu/share_6',array('user_id'=>$user_info['user_id'],'link_mobile'=>$user_info['link_mobile'],'user_name'=>$user_info['user_name'],'path'=>$path));?>">年关将至少喝酒，来看看我送你的福利！</a></p>
				</div>
