...
<style>
  ...
  .tab1{width: 50%; height: 38px;float: left; border-bottom: 1px solid #cccccc;}
  .tab2{width: 50%; height: 38px; float: left; color: #ef4a65; border-bottom: 2px solid #ef4a65;}
</style>
</head>
