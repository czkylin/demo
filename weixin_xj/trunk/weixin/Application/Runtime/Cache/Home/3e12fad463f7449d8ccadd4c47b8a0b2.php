...
<html lang="en">
    ...
    <body>
        ...
        <section class="login">
            <form action="<?php echo U('Home/User/band_phone_add');?>" method="post" id="form">
                <div class="box_login">
                    <div class="boxs">
                    ...
                    if(link_mobile!="")
                    {
                        if(isMobile(link_mobile))
                        {
                            if(sms_code!="")
                            {
                                ...
                                $.ajax({
                                    type: "POST",
                                    url: "/weixin/index.php?m=Home&c=User&a=band_phone_add",
                                    async: true,
                                    ...
                                    success: function(msg)
                                    {
                                        ...
                                        switch (msg)
                                        {
                                            //绑定成功 获取信息
                                            case '1':
                                                location.href="/weixin/index.php?m=Home&c=User&a=mywork_house&link_phone="+link_mobile;
                                                return;
                                                break; 
                                            case '0':
                                                location.href="/weixin/index.php?m=Home&c=User&a=mywork_house&link_phone="+link_mobile;
                                                ...
                                                //系统错误
                                            case '00001':
                                                location.href="/weixin/index.php?m=Home&c=User&a=band_fail";
                                                return;
                                                break;
                                            case '00014':
                    ...
                    if (link_mobile != "")
                    {
                        ...
                        if (isMobile(link_mobile))
                        {
                            ...
                            $.ajax({
                                ...
                                url: '<?php echo U('Home/User/send_msm');?>', //目标地址
                            ...
                            $.ajax({
                                ...
                                success: function(msg)
                                {
                                    switch (msg)
                                    {
                                        //绑定成功 获取信息
                                        case '1':
                                            location.href="/weixin/index.php?m=Member&c=User&a=mywork_house&link_phone="+link_mobile;
                                            return;
                                            break; 
                                        case '0':
                                            location.href="/weixin/index.php?m=Member&c=User&a=mywork_house&link_phone="+link_mobile;
