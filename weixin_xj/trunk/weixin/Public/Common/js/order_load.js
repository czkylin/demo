        ...
        , success: function (data) {
            ...
            if (data.length > 0 && data[0].trim() != "") {
                ...
                if (parseInt($('#current_pagenum').html()) == 1) {
                    $('#emptyData').show().html('<div class="empty_data" style="width: 100%;height: 100%; z-index:-1 ;display: box;display: -webkit-box;-webkit-box-pack:center;-webkit-box-align: center; position:absolute;top:0px;left:0;right:0;bottom:0;"><div><div style="text-align:center; width:100px;height:100px; margin:0 auto;overflow:hidden;margin-bottom:10px;"><img src="/weixin/Public/Common/images/icon/empty.png" width="100%"  style="margin-top:-700px;"/></div><p style="text-align:center;font-size:12px;">暂无数据</p><br></div></div>');
                    $('.ui-jiazai').hide();
                }
                else {
