...
//初始化日志
$logHandler= new CLogFileHandler("../../Runtime/Logs/app_order_xd".date('Y-m-d').'.log');
...
class PayNotifyCallBack extends WxPayNotify
{
	...
	public function NotifyProcess($data, &$msg)
	{
		...
		Log::DEBUG("APP_query_data1:" . json_encode($data1));
		$url="http://wx-heartorg.yk2020.com/weixin/index.php?m=Member&c=Wxpay&a=wx_notify_app_xd";
